...
class DiseasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post diseases_url, params: { disease: { asthma: @disease.asthma, bronch: @disease.bronch, copd: @disease.copd, lc: @disease.lc, region: @disease.region, year: @disease.year } }
    end
  ...
  test "should update disease" do
    patch disease_url(@disease), params: { disease: { asthma: @disease.asthma, bronch: @disease.bronch, copd: @disease.copd, lc: @disease.lc, region: @disease.region, year: @disease.year } }
